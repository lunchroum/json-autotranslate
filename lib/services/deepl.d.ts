...
export declare class DeepL implements TranslationService {
    ...
    initialize(config?: string, interpolationMatcher?: Matcher, decodeEscapes?: boolean, glossariesDir?: string, appName?: string, context?: string): Promise<void>;
     ...
     */
    recreateGlossary(from: string, to: string): Promise<DeepLGlossary>;
    /**
     * Delete a glossary.
     */
    ...
    getGlossary(from: string, to: string): Promise<DeepLGlossary>;
